...
public class API {
    private final static String DATA_ENDPOINT = "https://platform.shopyourway.com/products/search?" +
            "q=%s" +
            "&page=1" +
    ...
    public ArrayList<Product> get(String query) throws IOException {

        BufferedReader reader = null;
        URL url = new URL(String.format(DATA_ENDPOINT, query));
